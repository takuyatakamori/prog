...
//３．データ登録SQL作成
$sql = "INSERT INTO tkn_question_table(id, title, comment, tag1, tag2, tag3, u_id, q_name, sol, indate )
VALUES(NULL, :title, :comment, :tag1, :tag2, :tag3, :u_id, :q_name, 0, sysdate())";
