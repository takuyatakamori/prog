...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM tkn_question_table WHERE title LIKE '%$search%' OR comment LIKE '%$search%' OR tag1 LIKE '%$search%' OR tag2 LIKE '%$search%' OR tag3 LIKE '%$search%'");
$status = $stmt->execute();
